    ...
    return Container(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
            ...
            textStyle: AppTextStyle.semiBold600().copyWith(fontWeight: fontWeight, fontSize: fontSize ?? AppSize.fontSize14),
            elevation: 0),
        child: Row(
          ...
          children: [
            ...
            Text(
              ...
              style: isShowBorder
                  ? AppTextStyle.semiBold600(color: isDisable ? AppColors.buttonDisabledBgColor : textColor).copyWith()
                  : AppTextStyle.semiBold600(color: textColor).copyWith(),
            ),
