...
abstract class AppSize {
  static double fontSize5 = 5.sp;
  static double fontSize6 = 6.sp;
  static double fontSize7 = 7.sp;
  ...
  static double fontSize31 = 31.sp;
  static double fontSize32 = 32.sp;
  static double fontSize33 = 33.sp;
  static double fontSize34 = 34.sp;
  static double fontSize35 = 35.sp;
}
